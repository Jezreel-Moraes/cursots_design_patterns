from smart_light_command import *
...
for _ in range (5): smart_house_app.execute_command('MH_intensity')
for _ in range (3): smart_house_app.undo_command('MH_intensity')
